...
class EventSourceStream implements TransformStream<Uint8Array, MessageEvent<string>> {
    ...
    constructor() {
        ...
        function processChunk(controller: TransformStreamDefaultController<MessageEvent>, isLastChunk: boolean) {
        ...
        const sseStream = new TransformStream<string, MessageEvent>({
